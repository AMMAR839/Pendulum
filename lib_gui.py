...
class PendulumGUI:
	...
	def draw(self, context, graph_data):
		...
		self.btn_mode_2d.enabled = (self.active_mode != MODE_2D_SIM)
		self.btn_mode_graph.enabled = (self.active_mode != MODE_GRAPH)
		self.btn_mode_2d.draw(self.screen, self.font_medium)
		self.btn_mode_graph.draw(self.screen, self.font_medium)
